import { HelpCircle, Home, Package, RefreshCw, XCircle } from "lucide-react";
        ...
        <div className="bg-white rounded-2xl shadow-2xl p-8 space-y-6">
          ...
          <div className="space-y-3">
            {orderId ?
              <button
                onClick={handleRetry}
                className="w-full bg-red-600 hover:bg-red-700 text-white font-semibold py-3 px-4 rounded-xl transition-all duration-200 flex items-center justify-center gap-2 shadow-lg hover:shadow-xl cursor-pointer"
              >
