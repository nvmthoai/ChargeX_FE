    ...
    return (
        <div className="min-h-screen bg-gray-50 py-10">
            ...
            <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-3 gap-8 mt-10">
                <div className="bg-white rounded-xl shadow-md p-8 lg:col-span-2 space-y-12">
                    {sellers.map((slr: any, i: number) => (
                        <div key={i} className="flex flex-col gap-2">
                            {slr.orders.map((ord: any, j: number) => (
                                ...
                                <div
                                    key={j}
                                    className="group bg-white/90 backdrop-blur-sm rounded-2xl border border-ocean-200/50 p-4 hover:shadow-xl transition-all duration-300 animate-fadeIn"
                            ...
                            <div className="bg-[#fff9f9] border border-red-200 p-4 rounded-xl">
                                <div className="flex items-center gap-2">
                                    ...
                                    <span className="font-semibold">Người bán</span>{slr.fullName || "Không xác định"}
                                </div>
                            ...
                            <div className="bg-[#f7fbff] border border-blue-200 p-4 rounded-xl">
                                <div className="flex items-center gap-2">
                                    ...
                                    <span className="font-semibold">Người mua</span>{slr.orders[0]?.buyer?.fullName || "Bạn"}
                                </div>
                ...
                <div className="bg-white rounded-xl shadow-md p-8 space-y-6 sticky top-8">
                    ...
                    <button
                        className={`w-full py-3 mt-8 rounded-lg text-lg font-medium text-white transition ${processing || isWalletInsufficient ? "bg-gray-400 cursor-not-allowed" : "bg-blue-600 hover:bg-blue-700"
                            }`}
