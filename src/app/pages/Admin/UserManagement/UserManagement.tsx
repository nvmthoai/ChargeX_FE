...
// Biểu tượng (Icon) dạng SVG - Bạn có thể thay thế bằng thư viện icon
const ICONS = {
            ...
            <div className="inner-container user-management-container">
                ...
                <section className="stats-grid">
                    <div className="stat-card">
                        <span className="stat-title">Tổng khách hàng</span>
                    ...
                    <div className="stat-card">
                        <span className="stat-title">Trung bình đặt sân/người</span>
